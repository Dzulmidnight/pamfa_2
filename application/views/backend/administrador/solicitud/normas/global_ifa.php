																...
																<td>
																	<div class="row g-mb-20">
																		...
																		<div class="col-md-12 align-self-center">
																			...
																			data-error-class="u-has-error-v3" data-success-class="has-success" aria-required="true" value="<?php if (isset($consulta_ifa)) { echo $consulta_ifa->num_unidades_manip;}?>">
																			</div>
																		</div>
																	</div>
																</td>
													...
													<div class="col-sm-12">
														<div class="form-group g-mb-30">
															...
															<div class="g-pos-rel">
																...
																<input id="num_unidades_manipulacion" name="num_unidades_manipulacion" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="text" placeholder="Escribe aquí" <?php if (isset($consulta_mex)) {?>value="<?php  echo $consulta_ifa->num_unidades_manip;}else{?>value=""<?}?>>
															</div>
														</div>
													</div>
