									...
									<div>
										...
										<div class="row text-justify">
							                ...
							                <div class="col-lg-12">
							                	...
							                	<ul>
							                		...
							                		<li>
							                			...
							                			<p>
							                				Específicamente en el siguiente alcance: <span class="g-color-blue">Nombre del alcance seleccionado</span>.
							                			</p>
							                		</li>
							                		<li>
							                			“El Cliente” declara ser una persona moral o física con los siguientes datos:
							                			<br><span class="g-color-blue">Datos del cliente</span> y que su representante autorizado tiene la capacidad para obligarla en los términos de este instrumento. 
							                		</li>
							                		<li>
							                ...
							                <div class="col-lg-12">
							                	...
							                	<ul>
							                		<li>
							                			I.	El objeto del presente contrato es la evaluación de la conformidad del producto (s) <span class="g-color-blue">Nombre de los productos</span> de la empresa denominada: <span class="g-color-blue">Nombre de la empresa</span> bajo los lineamientos de la normatividad <span class="g-color-blue">Nombre de los esquemas</span>, que “El organismo de certificación” se compromete a prestarle a “el cliente”.  Las cláusulas de este contrato afectan a su vez a las evaluaciones no anunciadas y especiales (tanto extraordinarias como de modificación del alcance) en el presente ciclo de certificación. 
							                		</li>
							                		<li>
							                			II.	Las partes convienen que <span class="g-color-blue">Nombre del cliente</span> se obliga a pagar a “el organismo de certificación” la contraprestación estipulada en la cláusula tercera.
							                		</li>
							                		<li>
								...
								<div class="g-mt-20">
				                    ...
				                    <div class="row">
										<div class="col-sm-12">
						                    ...
						                    <p style="background: #72c02c; color:white" class="g-pa-10">
						                    	<i class="icon-check"></i> Aprobado
						                    </p>
