			...
			<div class="col-md-12">
	            ...
	            <div class="media-md align-items-center g-mb-30">
      				<div class="d-flex g-mb-15 g-mb-0--md">
      					<h3 class="g-font-weight-400 g-font-size-16 g-color-black mb-0">Lista de auditores / inspectores</h3>
      				</div>
      				...
      				<div class="media d-md-flex align-items-center ml-auto">
      					<a class="d-flex align-items-center u-link-v5 g-color-lightblue-v3 g-color-primary--hover" href="#!">
      						...
      						<span class="g-hidden-sm-down g-ml-10">Descargar lista</span>
      					</a>
							...
							<thead class="thead-light">
								<tr>
									...
									<th class="g-first-child">
										<div class="media">
											<div class="d-flex align-self-center">Tipo</div>
									...
									<th>
										<div class="media">
											<div class="d-flex align-self-center">Nombre</div>
									...
									<th>
										<div class="media">
											<div class="d-flex align-self-center">Telefono</div>
