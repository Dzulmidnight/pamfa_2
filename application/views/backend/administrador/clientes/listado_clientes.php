				...
				<div class="col-md-12 g-mb-0 g-mn-0--md">
					<div class="card border-0 rounded-0 g-mb-50">
						...
						<div class="js-scrollbar card-block u-info-v1-1 g-bg-white-gradient-v1--after g-height-300 g-pa-10">
			            	<!-- Tabla clientes -->
			            	<div class="table-responsive g-font-size-12">
				                <table class="js-datatable table table-hover u-table--v1 u-editable-table--v1 g-color-black" data-dt-info="#datatableInfo3" data-dt-search="#datatableSearch3" data-dt-pagination="datatablePagination3" data-dt-page-length="5" data-dt-is-responsive="false"
				                ...
				                data-dt-is-selectable="true">
									...
									<tbody>
										...
										<tr class="g-bg-gray-light-v8--opacity-0_4--checked">
											<!-- numero consecutivo -->
											<td class="">
												<?= '<span style="color:red">#'.$fila->id_cliente.'</span>'; ?>
											</td>
