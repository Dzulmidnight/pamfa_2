			...
			<div class="col-md-12">
	            ...
	            <div class="media-md align-items-center g-mb-30">
      				<div class="d-flex g-mb-15 g-mb-0--md">
      					<h3 class="g-font-weight-400 g-font-size-16 g-color-black mb-0">Lista de clientes</h3>
      				</div>
      				...
      				<div class="media d-md-flex align-items-center ml-auto">
      					<a class="d-flex align-items-center u-link-v5 g-color-lightblue-v3 g-color-primary--hover" href="#!">
      						...
      						<span class="g-hidden-sm-down g-ml-10">Descargar clientes</span>
      					</a>
      					...
      					<a class="d-flex align-items-center u-link-v5 g-color-lightblue-v3 g-color-primary--hover g-ml-15 g-ml-45--md" href="#!">
      						...
      						<span class="g-hidden-sm-down g-ml-10">Compartir</span>
      					</a>

      					<div class="d-flex g-ml-15 g-ml-55--md">
      						<div class="input-group g-pos-rel g-width-320--md">
      							<input id="datatableSearch3" class="form-control g-font-size-default g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-rounded-20 g-pl-20 g-pr-50 g-py-10" type="text" placeholder="Buscar por nombre">
	                ...
	                data-dt-is-selectable="true">
						...
						<tr>
							...
							<th class="g-first-child">
								<div class="media">
									<div class="d-flex align-self-center">Cliente</div>
							...
							<th>
								<div class="media">
									<div class="d-flex align-self-center">Estatus</div>
							...
							<th>
								<div class="media">
									<div class="d-flex align-self-center">Por definir</div>
