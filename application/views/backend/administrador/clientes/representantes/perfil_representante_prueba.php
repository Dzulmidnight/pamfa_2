					...
					<div class="card border-0 rounded-0 g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-40">
						<div class="row">
							<div class="col-lg-4 g-mb-40 g-mb-0--lg">
								<!-- User Image -->
								<div class="g-mb-20">
									<img class="img-fluid w-100" src="<?php echo base_url(); ?>assets/img-temp/400x450/img5.jpg" alt="Image Description">
								</div>
								<!-- User Image -->
							...
							<div class="col-lg-8">
								...
								<div class="d-flex align-items-center justify-content-sm-between g-mb-5">
									<h2 class="g-font-weight-300 g-mr-10">Nombre del representante</h2>
								...
								<!-- End Detalles de usuario -->

								<!-- Cargo usuario -->
								<h4 class="h6 g-font-weight-300 g-mb-10">
									<i class="icon-badge g-pos-rel g-top-1 g-mr-5 g-color-gray-dark-v5"></i> Cargo del representante
								</h4>
								<!-- End Cargo usuario -->
								...
								<ul class="list-inline g-font-weight-300">
									<li class="list-inline-item g-mr-20">
										<i class="icon-location-pin g-pos-rel g-top-1 g-color-gray-dark-v5 g-mr-5"></i> Oaxaca, México
									</li>
									<li class="list-inline-item g-mr-20">
										<i class="icon-check g-pos-rel g-top-1 g-color-gray-dark-v5 g-mr-5"></i> Usuario autorizado
									</li>
									<!--<li class="list-inline-item g-mr-20">
