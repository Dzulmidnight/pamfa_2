											...
											<div  class="col-md-6">
													...
													<div class="form-group">
														...
														<label id="divEsquema1" class="d-flex align-items-center justify-content-between" >
															...
															<div class="u-check">
																<input class="g-hidden-xs-up g-pos-abs g-top-0 g-right-0" id="check_globalgap_ifa" name="check_globalgap_ifa" type="checkbox" onclick="resaltarEsquema('check_globalgap_ifa','divEsquema1','img','cGlobal_ifa','GlobalGapIfa')">
											...
											<div  class="col-md-6">
													...
													<div class="form-group" >
														<label id="divEsquema2" class="d-flex align-items-center justify-content-between">
															...
															<div class="u-check">
																<input class="g-hidden-xs-up g-pos-abs g-top-0 g-right-0" id="check_globalgap_coc" name="check_globalgap_coc" type="checkbox" onclick="resaltarEsquema('check_globalgap_coc','divEsquema2','img','cGlobal_coc','GlobalGapCoc')">
																<div class="u-check-icon-radio-v8">
																	<i class="fa" data-check-icon="&#xf00c"></i>
																</div>
															</div>
													...
													<div class="form-group">
														<label id="divEsquema3" class="d-flex align-items-center justify-content-between">
															...
															<div class="u-check">
																...
																resaltarEsquema('check_mex_calidad_suprema','divEsquema3','img','cMcs','MexCalidadSuprema')">
																<div class="u-check-icon-radio-v8">
																	<i class="fa" data-check-icon="&#xf00c"></i>
																</div>
															</div>
											...
											<div  class="col-md-6">
													...
													<div class="form-group">
														<label id="divEsquema4" class="d-flex align-items-center justify-content-between">
															...
															<div class="u-check">
																<input class="g-hidden-xs-up g-pos-abs g-top-0 g-right-0" id="check_srrc" type="checkbox" onclick="resaltarEsquema('check_srrc','divEsquema4','img','cSrrc','Srrc')">
																<div class="u-check-icon-radio-v8">
																	<i class="fa" data-check-icon="&#xf00c"></i>
																</div>
															</div>
											...
											<div  class="col-md-6">
													...
													<div class="form-group" >
														<label id="divEsquema5" class="d-flex align-items-center justify-content-between">
															...
															<div class="u-check">
																<input class="g-hidden-xs-up g-pos-abs g-top-0 g-right-0" id="check_hecho_en_mexico" name="check_hecho_en_mexico" type="checkbox" onclick="resaltarEsquema('check_hecho_en_mexico','divEsquema5','img','cMexico','HechoEnMexico')">
											...
											<div  class="col-md-6">
													...
													<div class="form-group">
														<label id="divEsquema6" class="d-flex align-items-center justify-content-between">
															...
															<div class="u-check">
																<input class="g-hidden-xs-up g-pos-abs g-top-0 g-right-0" id="check_denominacion_origen" type="checkbox" onclick="resaltarEsquema('check_denominacion_origen','divEsquema6','img','cDen_origen','DenominacionOrigen')">
																<div class="u-check-icon-radio-v8">
																	<i class="fa" data-check-icon="&#xf00c"></i>
																</div>
															</div>
...
<script>
	function resaltarEsquema(id,div,elemento,c,d){
		var id = id;
		var div = div;
...
var valor = $('#'+id).prop('checked');
	...
	$.ajax({  
                     url:base_url+"backend/cliente/solicitud/Solicitudes/ingresa_norma/"+c+"/1",  
				...
				$.ajax({  
                     url:base_url+"backend/cliente/solicitud/Solicitudes/ingresa_norma/"+c+"/ ", 
            	...
            	$.ajax({  
                    url:base_url+"backend/cliente/solicitud/normas/"+c+"/eliminar",
		...
		if(valor){
			...
			//
			 $.ajax({  
		            	...
		            	success: function() { 
		            		...
		            		$("#div"+d).load(base_url+"backend/cliente/solicitud/normas/"+c+"/div");
			...
			if (d=='Srrc') {
			 ...
			 $.ajax({  
        	  ...
        	  $.ajax({  
                    url:base_url+"backend/cliente/solicitud/normas/"+c+"/guardar",
        	...
        	$.ajax({  
		            	...
		            	success: function() { 
		            		$("#tabla3").load(base_url+'backend/cliente/solicitud/normas/cProducto_srrc/div');
		            		$("#divSrrc").load(base_url+'backend/cliente/solicitud/normas/cSrrc/div');
...
formdata3.append('idiomas',$('#idiomas').val());
		...
		$.ajax({
			type:'POST',
			url:base_url+"backend/cliente/solicitud/solicitudes/actualizar_final",
			data: formdata3,
			dataType: 'text',
			cache: false,
        	contentType: false,
			...
			success:function(data){
					location.href =base_url+"backend/cliente/main";
		                       }
...
function cambiar(n){
 ...
 $.ajax({  
                     url:base_url+"backend/cliente/cCliente/generales_sol",  
                     method:"POST",
                    data:dataString,
		            	success: function(data) { 
 ...
 $.ajax({  
                     url:base_url+"backend/cliente/cCliente/fiscal_sol",  
                     method:"POST",
                    data:dataString,
		            	success: function(data) { 
 ...
 $.ajax({  
                     url:base_url+"backend/cliente/solicitud/cCert_anterior_sol/guardar_c", 
...
formdata.append('num_unidades_manip',$('#num_unidades_manipulacion').val());
		...
		$.ajax({
			type:'POST',
			url:base_url+"backend/cliente/solicitud/normas/cGlobal_ifa/actualizar",
			data: formdata,
			dataType: 'text',
			cache: false,
        	contentType: false,
...
formdata2.append('coc_preg3',$('input[name=coc_preg3]:checked').val());
		...
		$.ajax({
			type:'POST',
			url:base_url+"backend/cliente/solicitud/normas/cGlobal_coc/actualizar",
			data: formdata2,
			dataType: 'text',
			cache: false,
        	contentType: false,
...
if($('#check_srrc').prop('checked') ) {
 ...
 $.ajax({  
                     url:base_url+"backend/cliente/solicitud/normas/cSrrc/actualizar", 
...
formdata.append('descripcion_den',$('#descripcion_den').val());
 ...
 $.ajax({  
                     url:base_url+"backend/cliente/solicitud/normas/cDen_origen/actualizar", 
...
formdata.append('trazabilidad',$('#trazabilidad_mcs').val());
 ...
 $.ajax({  
                     url:base_url+"backend/cliente/solicitud/normas/cMcs/actualizar", 
...
function agregar(){
 ...
 $.ajax({  
                     url:base_url+"backend/cliente/solicitud/normas/cMexico/guardar", 
...
var idproducto=x;
 ...
 $.ajax({  
                     url:base_url+"backend/cliente/solicitud/normas/cMexico/eliminar", 
...
function agregar2(){
 ...
 $.ajax({  
                     url:base_url+"backend/cliente/solicitud/normas/cProducto_srrc/guardar", 
...
var idproducto=x;
 ...
 $.ajax({  
                     url:base_url+"backend/cliente/solicitud/normas/cProducto_srrc/eliminar", 
...
function uploadFile(al){
  ...
  ajax.open("POST", base_url+"backend/cliente/solicitud/normas/cDen_origen/subir_archivo");
...
var ajax = new XMLHttpRequest();
  ...
  ajax.open("POST", base_url+"backend/cliente/solicitud/normas/cMcs/subir_archivo");
  ajax.send(formdata);
  }
   if( al== 2){
var ajax = new XMLHttpRequest();
...
function uploadFile3(){
	...
	ajax.open("POST", base_url+"backend/cliente/solicitud/normas/cMcs/subir_archivo2");
...
function completeHandler5(event){
	...
	$("#tabla_mexcalsup").load(base_url+"backend/cliente/solicitud/normas/cMcs/tabla");
...
var anexo2=z;
 ...
 $.ajax({  
                     url:base_url+"backend/cliente/solicitud/normas/cMcs/eliminar_equipo", 
