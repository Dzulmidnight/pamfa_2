		...
		<div class="u-header__section u-header__section--admin-light u-shadow-v22 g-min-height-65">
			<nav class="navbar no-gutters g-pa-0">
				<div class="col-auto d-flex flex-nowrap u-header-logo-toggler g-py-12">
					<!-- Logo -->
					<a href="<?php echo base_url('backend/cliente/main'); ?>" class="navbar-brand d-flex align-self-center g-hidden-xs-down g-line-height-1 py-0 g-mt-5">
						<img class="img-responsive" src="<?php echo base_url(); ?>assets/img/logo/logo_pamfa_dashboard.png" alt="">
					</a>
					<!-- End Logo -->
					...
					<div class="g-pos-rel g-hidden-sm-down g-mr-5">
						...
						<div id="messagesMenu" class="g-absolute-centered--x g-width-340 g-max-width-400 g-mt-17 rounded" aria-labelledby="messagesInvoker">
							<div class="media u-header-dropdown-bordered-v1 g-pa-20">
								<h4 class="d-flex align-self-center text-uppercase g-font-size-default g-letter-spacing-0_5 g-mr-20 g-mb-0">0 nuevos mensajes</h4>
								<div class="media-body align-self-center text-right">
									<a class="g-color-secondary" href="#!">Ver todos</a>
								</div>
							</div>
						<!--
							<ul class="p-0 mb-0">
								...
								<li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
									<div class="d-flex g-mr-15">
										<img class="g-width-40 g-height-40 rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img5.jpg" alt="Image Description">
									</div>
								...
								<li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
									<div class="d-flex g-mr-15">
										<img class="g-width-40 g-height-40 rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img6.jpg" alt="Image Description">
									</div>
								...
								<li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
									<div class="d-flex g-mr-15">
										<img class="g-width-40 g-height-40 rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img7.jpg" alt="Image Description">
									</div>
						...
						<div class="g-pos-rel g-px-10--lg">
							...
							data-dropdown-animation-in="fadeIn" data-dropdown-animation-out="fadeOut">
								<span class="g-pos-rel">
									...
									<img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle g-mr-10--sm" src="<?php echo base_url(); ?>admin/assets/img/logo/icono_pamfa.png" alt="Image description">
								</span>
								<span class="g-pos-rel g-top-2">
									<span class="g-hidden-sm-down">Nombre de usuario</span>
							...
							<ul id="profileMenu" class="g-pos-abs g-left-0 g-width-100x--lg g-nowrap g-font-size-14 g-py-20 g-mt-17 rounded" aria-labelledby="profileMenuInvoker">
								...
								<li class="g-mb-10">
									<a class="media g-color-lightred-v2--hover g-py-5 g-px-20" href="<?php echo base_url('backend/cliente/usuario/perfiles'); ?>">
										<span class="d-flex align-self-center g-mr-12">
								...
								<li class="mb-0">
									<a class="media g-color-lightred-v2--hover g-py-5 g-px-20" href="<?php echo base_url('CLogin/salir'); ?>">
										<span class="d-flex align-self-center g-mr-12">
