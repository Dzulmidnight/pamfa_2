        ...
        <i class="g-fill-lightblue-v3">
          <svg width="12px" height="20px" viewBox="0 0 12 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <div class="col-xl-4">
              ...
              <!-- Calendar Card -->
              <div class="u-card-v1 g-rounded-4 g-overflow-hidden g-mb-30">
                <header class="u-bg-overlay g-bg-img-hero g-bg-black-opacity-0_5--after" style="background-image: url(<?php echo base_url(); ?>admin/assets/img-temp/400x270/img3.jpg);">
        ...
        <span class="d-block g-font-size-16">January 2017</span>
                    ...
                    <div class="g-orientation-left g-pos-rel g-ml-25--md g-pl-20">
                      ...
                      <div class="media g-mb-16">
                        <div class="d-flex align-self-center g-mr-15">
                          <img class="g-width-55 g-height-55 rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img1.jpg" alt="Image Description">
                        </div>
          ...
          <span class="g-font-weight-300 g-font-size-12 g-font-size-default--md g-ml-4 g-ml-8--md">45 Min <span class="g-hidden-md-down">ago</span></span>
                    ...
                    <div class="g-orientation-left g-pos-rel g-ml-25--md g-pl-20">
                      ...
                      <div class="media g-mb-25">
                        <div class="d-flex align-self-center g-mr-15">
                          <img class="g-width-55 g-height-55 rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img4.jpg" alt="Image Description">
                        </div>
          ...
          <span class="g-font-weight-300 g-font-size-12 g-font-size-default--md g-ml-4 g-ml-8--md">10 Min <span class="g-hidden-md-down">ago</span></span>
                    ...
                    <div class="g-orientation-left g-pos-rel g-ml-25--md g-pl-20">
                      ...
                      <div class="media g-mb-16">
                        <div class="d-flex align-self-center g-mr-15">
                          <img class="g-width-55 g-height-55 rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img5.jpg" alt="Image Description">
                        </div>
          ...
          <span class="g-font-weight-300 g-font-size-12 g-font-size-default--md g-ml-4 g-ml-8--md">10 Min <span class="g-hidden-md-down">ago</span></span>
                    ...
                    <div class="g-orientation-left g-pos-rel g-ml-25--md g-pl-20">
                      ...
                      <div class="media g-mb-16">
                        <div class="d-flex align-self-center g-mr-15">
                          <img class="g-width-55 g-height-55 rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img7.jpg" alt="Image Description">
                        </div>
                      ...
                      <ul class="list-inline d-flex g-mb-20">
                        <li class="list-inline-item g-mb-10 g-mb-0--sm mr-0">
                          <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img4.jpg" alt="Image Description">
                        </li>
                        <li class="list-inline-item g-mb-10 g-mb-0--sm g-ml-7 mr-0">
                          <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img7.jpg" alt="Image Description">
                        </li>
                        <li class="list-inline-item g-mb-10 g-mb-0--sm g-ml-7 mr-0">
                          <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img14.jpg" alt="Image Description">
                        </li>
                        <li class="list-inline-item g-mb-10 g-mb-0--sm g-ml-7 mr-0">
                          <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img15.jpg" alt="Image Description">
                        </li>
                        <li class="list-inline-item g-mb-10 g-mb-0--sm g-ml-7 mr-0">
          ...
          <span class="g-font-weight-300 g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-ml-4 g-ml-8--md">10 Min <span class="g-hidden-md-down">ago</span></span>
                ...
                <div class="js-custom-scroll g-height-400 g-pa-15 g-pa-0-30-25--md">
                  <section class="media">
                    <div class="d-flex g-mr-12">
                      <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img5.jpg" alt="Image Description">
                    </div>
            ...
            <span class="g-font-weight-300 g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-ml-4 g-ml-8--md">45 Min <span class="g-hidden-md-down">ago</span></span>
                  ...
                  <section class="media">
                    <div class="d-flex g-mr-12">
                      <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img14.jpg" alt="Image Description">
                    </div>
            ...
            <span class="g-font-weight-300 g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-ml-4 g-ml-8--md">15 Min <span class="g-hidden-md-down">ago</span></span>
                  ...
                  <section class="media">
                    <div class="d-flex g-mr-12">
                      <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="<?php echo base_url(); ?>admin/assets/img-temp/100x100/img7.jpg" alt="Image Description">
                    </div>
