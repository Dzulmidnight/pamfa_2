								...
								<div class="row g-mb-20">
									...
									<div class="col-md-9 align-self-center">
										<div class="form-group g-pos-rel mb-0">
											...
											<textarea id="nombreLegal" name="nombreLegal" class="form-control form-control-md u-textarea-expandable g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-resize-none g-overflow-hidden" rows="3" placeholder=""></textarea>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row g-mb-20">
									...
									<div class="col-md-9 align-self-center">
										<div class="form-group g-pos-rel mb-0">
											...
											<textarea id="nombreRepresentante" name="nombreRepresentante" class="form-control form-control-md u-textarea-expandable g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-resize-none g-overflow-hidden" rows="3" placeholder=""></textarea>
										</div>
									</div>
								</div>
							</div>
